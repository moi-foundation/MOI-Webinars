# SDK_NOTES.md — session 8 (V2: authority)
...
The full protocol also runs today without a wallet: `CHAIN_MODE=mock pnpm demo` and
`CHAIN_MODE=mock pnpm attack-test`. See README.

Session 7's notes are the base; this file adds the context-inheritance surface (§2.2) that session
7 deliberately does not use.
...
## §2.2 — Context inheritance ✅ CONFIRMED, with one clarification
