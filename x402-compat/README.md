...
Settlement first: on MOI the buyer submits its own transfer and pays its own fuel. By the time the
seller sees a payment, the money has already moved, and there is nothing left to settle.
