...
- The [Coco toolchain (cocolang)](https://cocolang.dev/docs/install) — required for Session 1 CocoLab demos, and for recompiling `.coco` sources in either session.
